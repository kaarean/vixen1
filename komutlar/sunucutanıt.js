...
.setDescription('Sunucunuz başarıyla tanıtıldı.[**Gitmek İçin Tıklayın**](https://discord.gg/GKuZKBx)')
        .setColor('RANDOM')
 message.channel.sendEmbed(embed);
    message.channel.createInvite({maxAge: 0}).then((invite) => {
      ...
      .setThumbnail(message.guild.iconURL)
       client.channels.get('651103434711498782').send(embed)
            });
